export const doctorProfilesSeed = [
  {
    _id: 'doctorProfile-1',
    _type: 'doctorProfile',
    doctorId: 1,
    ...
    specialtyGroups: [
      {_key: 'internal', slug: 'internal', name: '內科', items: ['失眠', '自律神經失調', '癌症術後調理', '各類雜病調理']},
      {_key: 'gynecology', slug: 'gynecology', name: '婦科', items: ['不孕症調理', '產後調理', '更年期症候群']},
      {_key: 'pediatrics', slug: 'pediatrics', name: '兒科', items: ['注意力不足過動症輔助治療', '小兒近視輔助治療', '小兒轉骨']},
      {_key: 'dermatology', slug: 'dermatology', name: '皮膚科', items: ['青春痘', '蕁麻疹', '濕疹', '汗皰疹', '乾癬']},
      {_key: 'acupuncture', slug: 'acupuncture', name: '針灸科', items: ['中風後遺症', '帕金森氏症', '顏面神經麻痺', '手術後疤痕沾黏後遺症', '筋骨痠痛']},
    ],
  ...
  },
  {
    ...
    specialtyGroups: [
      {_key: 'dermatology', slug: 'dermatology', name: '皮膚科', items: ['青春痘', '蕁麻疹', '汗皰疹', '濕疹']},
      {_key: 'gynecology', slug: 'gynecology', name: '婦科', items: ['月經調理', '白帶', '更年期', '不孕']},
      {_key: 'internal', slug: 'internal', name: '內科', items: ['失眠', '便秘', '鼻過敏', '小兒轉骨']},
      {_key: 'acupuncture', slug: 'acupuncture', name: '針灸科', items: ['顏面神經麻痺', '中風後遺症', '痠痛']},
      {_key: 'beauty', slug: 'beauty', name: '中醫美容', items: ['美顏針', '中藥減重', '針灸雕塑']},
    ],
    specialTreatments: [],
    schedule: {
  ...
  },
  {
    ...
    experience: ['義大醫院中醫部'],
    specialtyGroups: [
      {_key: 'gynecology', slug: 'gynecology', name: '婦科', items: ['月經疾患', '不孕症', '產後調理', '更年期症候群']},
      {_key: 'pediatrics', slug: 'pediatrics', name: '兒科', items: ['過敏性鼻炎', '兒少成長']},
      {_key: 'dermatology', slug: 'dermatology', name: '皮膚科', items: ['濕疹', '痤瘡', '落髮']},
      {_key: 'internal', slug: 'internal', name: '內科', items: ['腸胃功能障礙', '感冒']},
      {_key: 'beauty', slug: 'beauty', name: '中醫美容', items: ['減重', '膚況膚質調理']},
    ],
    specialTreatments: [],
    schedule: {
      morning: {label: '早診', time: '09–12', mon: true, tue: false, wed: false, thu: true, fri: false, sat: true, sun: false},

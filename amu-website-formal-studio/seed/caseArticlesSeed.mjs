export const caseArticlesSeed = [
  {
    ...
    description:
      '50歲女性五個月前中風，中風後開始失眠，服用安眠藥後狀況仍不佳...22點就寢→24點需起床再服藥→只能睡到2點半，晨起頭昏重，情緒不佳且厭食，因此來就診…',
    before: {
      title: '治療前症狀',
      ...
      phases: [
        {
          _key: 'case-1-phase-1',
          period: '一週後',
          improvements: ['早醒可以睡到4點', '頭昏減緩', '情緒不佳及厭食持平'],
        },
        {
          _key: 'case-1-phase-2',
          period: '2個月後',
          improvements: ['早醒直接睡到6點', '頭昏痊癒且精神狀況較好', '情緒不佳及厭食明顯改善'],
        },
      ],
    },
  ...
  },
  {
    ...
    description:
      '20多歲男性，因為第一型糖尿病長期使用胰島素及血糖藥控制，但最近血糖控制不佳，晨起飯前血糖近200 mg/dl，且常有低血糖頭暈問題，因為不希望再增加胰島素或血糖藥物用量，故前來就診…',
    before: {
      title: '治療前症狀',
      ...
      phases: [
        {
          _key: 'case-2-phase-1',
          period: '第一週後',
          improvements: ['晨起血糖由 200 mg/dl → 150 mg/dl', '低血糖頭暈問題消失'],
        },
        {
          _key: 'case-2-phase-2',
          period: '持續調養中',
          improvements: ['晨起血糖穩定在 130-150 mg/dl', '無低血糖頭暈問題', '長久以來的軟便症狀也獲得改善'],
        },
      ],
    },
  ...
  },
  {
    ...
    description:
      '38歲女性，結婚兩年多無避孕但一直無法懷孕，經朋友介紹來找李醫師看診…考量患者年紀，李醫師先詢問是否曾做過基本的檢查以利排除輸卵管阻塞或子宮肌瘤等結構性問題。患者表示西醫檢查後夫妻雙方皆無特殊異常，並已在其他中醫機構調理許久但遲遲未果，若這幾個月仍無法順利懷孕，將考慮做試管嬰兒...',
    before: {
      title: '治療前狀況',
      ...
      phases: [
        {
          _key: 'case-3-phase-1',
          period: '調理後',
          improvements: ['原本準時的月經遲到', '約一週後自行驗孕發現已順利懷孕', '超音波檢查胎兒心跳正常'],
        },
      ],
    },
    conclusion:
      '患者來診時恰逢月經結束且自述月經非常準時，李醫師便根據患者當時的身體狀況給予合適的藥物處置並做適當的衛教，成功幫助患者自然受孕！',
    tips: {
      title: '貼心小提醒',
      content:
        '根據一般婦產科建議，想要懷孕的夫妻何時應積極求診？在沒有避孕的情況下：小於35歲嘗試懷孕時間：一年 / 35-38歲嘗試懷孕時間：半年 / 大於39歲嘗試懷孕時間：立即求診',
    },
  ...
  },
  {
    ...
    description:
      '37歲女性結婚2年，已積極備孕一年餘但仍無好消息。為此有先至西醫檢查發現可能為子宮內膜息肉影響，因此有先處理該狀況，其餘檢查無異常，因此西醫建議可以再嘗試自然受孕看看，但歷經三個月仍無好消息。為了上述的狀況患者希望搭配中醫治療助孕，因此前來求診。患者除了上述問題外還有睡眠狀況不佳的問題…',
    before: {
      title: '治療前狀況',
      ...
      phases: [
        {
          _key: 'case-4-phase-1',
          period: '調理後',
          improvements: ['睡眠不佳問題改善', '成功受孕', '目前已經進入第三孕期'],
        },
      ],
    },
    medicalInfo: {
      title: '醫學小知識',
      content:
        '子宮內膜息肉，是由子宮內膜的上皮黏膜細胞增生而生成的腺體腫瘤，數量可從單一個到多個，息肉不但會增生還可能變大。對於想要懷孕的女性而言，一般會依照息肉的「大小」和「位置」，來評估需採取的治療。',
    },
  ...
  },
  {
    ...
    description:
      '19歲女性，近半年私密處反覆發炎，時常有黃綠色分泌物，甚則誘發右下腹痛，平均一個月要至婦產科或急診1-2次，時常在治療後1-2周又復發，症狀反覆不癒困擾不已。本次來就診是因為晨起又有綠色分泌物出現，且伴隨右下腹痛，但由於西醫治療一直反覆不癒想以中醫治療看看。',
    before: {
      title: '治療前症狀',
    ...
    after: {
      title: '治療後成果',
      phases: [
        {_key: 'case-5-phase-1', period: '服藥5天後', improvements: ['綠色分泌物減少', '右下腹壓痛減少']},
        {_key: 'case-5-phase-2', period: '10日後回診', improvements: ['綠色分泌物已無', '右下腹壓痛已無', '生理期正常來潮']},
        {_key: 'case-5-phase-3', period: '一個月調理後', improvements: ['無分泌物異常', '無腹部壓痛情況', '狀況穩定順利畢業']},
        {_key: 'case-5-phase-4', period: '2個月後追蹤', improvements: ['私密處感染與腹部痛的情況已無發生']},
      ],
    },
    medicalInfo: {
      title: '衛教小天地',
      content:
        '在私密處感染時，西醫所使用的塞劑或抗生素確實是很好的治療手段，但是如果再治療後並沒有注意自己的生活習慣使得自身的免疫力下降很容易又再度復發。而中醫在預防復發上佔了很重要的角色，由於中醫在免疫調節上是很佔優勢的，如同此例，患者在將近1.5個月的治療就解決了困擾半年多私密處反覆感染的問題。',
    },

  ...
  doctors: [
    {
      ...
      education: [{text: '陽明大學 微生物免疫學研究所'}, {text: '義守大學 學士後中醫學系'}],
      experience: [{text: '高雄長庚中醫科系 醫師'}, {text: '仁醫堂中醫診所 醫師'}],
      licenseItems: [],
      specialtyGroups: [
    ...
    },
    {
      ...
      education: [{text: '義守大學 學士後中醫學系'}],
      experience: [{text: '奇美醫學中心中醫部'}, {text: '台南市立醫院中醫部'}],
      licenseItems: [],
      specialtyGroups: [
    ...
    },
    {
      ...
      education: [{text: '義守大學 學士後中醫學系'}, {text: '中山醫學大學 物理治療學系'}],
      experience: [{text: '義大醫院中醫部'}],
      licenseItems: [],
      specialtyGroups: [

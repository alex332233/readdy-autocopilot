...
export default function EyeDetailSection({ detail }: EyeDetailSectionProps) {
  const sections = eyeDetailData.sections;
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-white to-[#f2f7f7]">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div className="w-full h-px bg-gradient-to-r from-transparent via-[#5c8f8c]/30 to-transparent mb-16" />

        <div className="mb-16 grid grid-cols-1 lg:grid-cols-2 gap-0 rounded-2xl overflow-hidden border border-[#d8eaea] min-h-[560px]">
          ...
          <div className="relative min-h-[400px] lg:min-h-0">
            <img src={primaryImage} alt="眼部困擾" className="absolute inset-0 w-full h-full object-cover object-top" />
        ...
        <div className="mb-16 grid grid-cols-1 lg:grid-cols-2 gap-0 rounded-2xl overflow-hidden border border-[#d8eaea] min-h-[560px]">
          <div className="relative min-h-[400px] lg:min-h-0 order-2 lg:order-1">
            <img src={secondaryImage} alt="艾苜眼針解方" className="absolute inset-0 w-full h-full object-cover object-top" />
            <div className="absolute inset-0 bg-gradient-to-l from-white/20 to-transparent" />
          </div>
          <div className="bg-[#f5fbfb] px-12 py-16 lg:px-16 lg:py-20 flex flex-col justify-center order-1 lg:order-2">
            <div className="flex items-center gap-3 mb-8">
              <div className="w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: ACCENT }}>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {sections[3].items.map((item, itemIdx) => (
              <div key={itemIdx} className="bg-white rounded-xl border border-[#d8eaea] p-6 hover:border-[#5c8f8c]/50 hover:shadow-sm transition-all duration-200">
        ...
        <div className="bg-[#f5fbfb] rounded-xl p-6 border border-[#d8eaea]" style={{ borderLeftWidth: '4px', borderLeftColor: ACCENT }}>
          <div className="flex items-start gap-3">
            ...
            <p className="text-xs lg:text-sm text-gray-500 leading-relaxed">{eyeDetailData.disclaimer}</p>
          </div>
        </div>

        <TreatmentCasesSection cases={cases} accent="#5c8f8c" />

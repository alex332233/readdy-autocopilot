...
export default function BodyDetailSection({ detail }: BodyDetailSectionProps) {
  const sections = (detail.sections.length >= 4 ? detail.sections : bodyDetailData.sections) as Array<
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div className="mb-16 grid grid-cols-1 lg:grid-cols-2 gap-0 rounded-2xl overflow-hidden border border-[#ede8df] min-h-[560px]">
          ...
          <div className="relative min-h-[400px] lg:min-h-0" data-sanity-edit-group data-sanity-edit-target>
            <img src={primaryImage} alt="體態困擾" className="absolute inset-0 w-full h-full object-cover object-top" data-sanity={dataAttribute('primaryImage')} />
        ...
        <div className="mb-16 grid grid-cols-1 lg:grid-cols-2 gap-0 rounded-2xl overflow-hidden border border-[#ede8df] min-h-[560px]">
          <div className="relative min-h-[400px] lg:min-h-0 order-2 lg:order-1" data-sanity-edit-group data-sanity-edit-target>
            <img src={secondaryImage} alt="艾苜體雕解方" className="absolute inset-0 w-full h-full object-cover object-top" data-sanity={dataAttribute('secondaryImage')} />
        ...
        <div className="bg-[#fdfaf6] rounded-xl p-6 border border-[#ede8df]" style={{ borderLeftWidth: '4px', borderLeftColor: ACCENT }}>
          <div className="flex items-start gap-3">
            ...
            <p className="text-xs lg:text-sm text-gray-500 leading-relaxed" data-sanity={dataAttribute('disclaimer')}>{detail.disclaimer || bodyDetailData.disclaimer}</p>
          </div>
        </div>

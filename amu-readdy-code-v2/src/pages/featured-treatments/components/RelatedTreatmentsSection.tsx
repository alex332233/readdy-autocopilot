...
export default function RelatedTreatmentsSection({ cards, currentSlug }: RelatedTreatmentsSectionProps) {
  ...
  const otherTreatments = cards.filter((card) => card.detailSlug !== currentSlug);

  return (
    <section className="py-20 bg-[#fdfaf6]">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        <div className="flex flex-col items-center text-center mb-12">
          <span className="text-xs tracking-[0.25em] text-[#cd9651] uppercase mb-3 font-medium">Explore More</span>
              ...
              >
                ...
                <div className="p-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h3 className="text-base font-bold text-gray-800 leading-tight" style={{ fontFamily: "'Noto Serif TC', serif" }}>
                        {item.title}
                      </h3>

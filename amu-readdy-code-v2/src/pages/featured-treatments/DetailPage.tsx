...
export default function FeaturedTreatmentDetailPage() {
  ...
  const detailDataAttribute = (path: string) =>
    detail._id
  ...
  return (
    <div className="relative">
      ...
      <main>
        ...
        >
          <div className="max-w-7xl mx-auto px-6 py-20 flex flex-col items-center text-center">
            <h1 className="text-4xl lg:text-5xl font-bold mb-4 leading-tight" style={{ fontFamily: "'Noto Serif TC', serif", color: detail.themeColor, ...fadeUp(100) }}>
              <span data-sanity={detailDataAttribute('title')}>{detail.title}</span>
            </h1>
            <p className="text-base text-gray-600 max-w-lg leading-relaxed" style={fadeUp(300)}>
              <span data-sanity={detailDataAttribute('subtitle')}>{detail.subtitle}</span>
            </p>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
                ...
                <div key={`${section.title}-${sectionIndex}`}>
                  ...
                  {section.layout === 'textOnly' && (
                    <div className="mb-16">
                      <div className="flex items-center gap-3 mb-6">
                        ...
                        <h3 className="text-xl lg:text-2xl font-serif font-bold text-gray-800 tracking-wide" data-sanity={detailDataAttribute(`sections[${sectionIndex}].title`)}>
                          {section.title}
                        </h3>
                      </div>
                      <div className="pl-12">
                        {section.eyebrow && <p className="text-sm lg:text-base font-semibold mb-3 tracking-wide" style={{ color: detail.themeColor }} data-sanity={detailDataAttribute(`sections[${sectionIndex}].eyebrow`)}>{section.eyebrow}</p>}
                        {section.content && <p className="text-sm lg:text-base text-gray-600 leading-loose" data-sanity={detailDataAttribute(`sections[${sectionIndex}].content`)}>{section.content}</p>}
                      </div>
                    </div>
                  )}
                    ...
                    <div className="mb-16 grid grid-cols-1 lg:grid-cols-2 gap-0 rounded-2xl overflow-hidden shadow-sm border border-[#ede8df]">
                      {section.layout === 'imageText' && section.image && (
                        <div className="relative min-h-[320px] lg:min-h-0 order-2 lg:order-1" data-sanity-edit-group data-sanity-edit-target>
                          <img src={getSanityImageUrl(section.image, { width: 900, height: 720, fit: 'crop', quality: 86 })} alt={section.image.alt} className="absolute inset-0 w-full h-full object-cover object-top" data-sanity={detailDataAttribute(`sections[${sectionIndex}].image`)} />
                      ...
                      <div className={`p-8 lg:p-10 flex flex-col justify-center ${section.layout === 'imageText' ? 'bg-[#fdfaf6] order-1 lg:order-2' : 'bg-white'}`}>
                        ...
                        {section.content && <p className="text-sm lg:text-base text-gray-600 leading-loose mb-5" data-sanity={detailDataAttribute(`sections[${sectionIndex}].content`)}>{section.content}</p>}
                        {section.additionalContent && <p className="text-sm lg:text-base text-gray-600 leading-loose mb-5" data-sanity={detailDataAttribute(`sections[${sectionIndex}].additionalContent`)}>{section.additionalContent}</p>}
                              ...
                              {section.items.map((item, itemIdx) => (
                                <div key={itemIdx} className="bg-[#faf8f5] rounded-lg p-4 border border-[#e8ddd0]" >
                                  <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <h4 className="text-sm font-bold text-gray-800 tracking-wide" data-sanity={detailDataAttribute(`sections[${sectionIndex}].items[${itemIdx}].subtitle`)}>{item.subtitle}</h4>
                                  </div>
                                  <p className="text-xs text-gray-600 leading-relaxed pl-7" data-sanity={detailDataAttribute(`sections[${sectionIndex}].items[${itemIdx}].text`)}>{item.text}</p>
                                </div>
                              ))}
                            </div>
                          ) : (
                            <div className="space-y-3">
                              {section.items.map((item, itemIdx) => (
                                <div key={itemIdx} className="flex gap-3 items-start">
                                  ...
                                  <div>
                                    <h4 className="text-sm font-semibold text-gray-800 mb-1 tracking-wide" data-sanity={detailDataAttribute(`sections[${sectionIndex}].items[${itemIdx}].subtitle`)}>{item.subtitle}</h4>
                                    <p className="text-xs text-gray-600 leading-relaxed" data-sanity={detailDataAttribute(`sections[${sectionIndex}].items[${itemIdx}].text`)}>{item.text}</p>
                                  </div>
                                </div>
                              ))}
                            </div>
                          ...
                          {section.items.map((item, itemIdx) => (
                            <div key={itemIdx} className="bg-white rounded-xl border border-[#ede8df] p-6 hover:shadow-sm transition-all duration-200">
                              <div className="flex items-start gap-4">
                                ...
                                <div>
                                  <h4 className="text-base font-semibold text-gray-800 mb-2 tracking-wide" data-sanity={detailDataAttribute(`sections[${sectionIndex}].items[${itemIdx}].subtitle`)}>{item.subtitle}</h4>
                                  <p className="text-sm text-gray-600 leading-relaxed" data-sanity={detailDataAttribute(`sections[${sectionIndex}].items[${itemIdx}].text`)}>{item.text}</p>
                                </div>
                              </div>
                            </div>
                          ))}
                          ...
                          {section.cases.map((caseItem, caseIdx) => (
                            <div key={caseIdx} className="bg-[#fdfaf6] rounded-xl p-5 border border-[#ede8df]">
                              <p className="text-sm text-gray-600 leading-relaxed">
                                <strong style={{ color: detail.themeColor }} data-sanity={detailDataAttribute(`sections[${sectionIndex}].cases[${caseIdx}].label`)}>{caseItem.label}：</strong>
                                <span data-sanity={detailDataAttribute(`sections[${sectionIndex}].cases[${caseIdx}].text`)}>{caseItem.text}</span>
                              </p>
                            </div>
                          ))}
                        </div>
                  ...
                  {section.layout === 'processCards' && (
                    <div className="mb-16">
                      ...
                      {section.content && <p className="text-sm text-gray-500 pl-12 mb-8" data-sanity={detailDataAttribute(`sections[${sectionIndex}].content`)}>{section.content}</p>}
                      {section.items && (
            ...
            {detail.disclaimer && (
              <div className="bg-[#fdfaf6] rounded-xl p-6 border border-[#ede8df] border-l-4" style={{ borderLeftColor: detail.themeColor }}>
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-xs lg:text-sm text-gray-500 leading-relaxed" data-sanity={detailDataAttribute('disclaimer')}>{detail.disclaimer}</p>
                </div>
              </div>
            )}
            ...
            <div className="mt-16 rounded-3xl overflow-hidden relative" style={{ backgroundColor: detail.themeColor }}>
              <div className="relative z-10 py-16 px-10 text-center text-white">
                <h3 className="text-2xl lg:text-3xl font-serif font-normal mb-4" data-sanity={detailDataAttribute('ctaTitle')}>{detail.cta.title}</h3>
                <p className="text-base text-white/80 mb-8 max-w-xl mx-auto" data-sanity={detailDataAttribute('ctaDescription')}>{detail.cta.description}</p>
                <button
                  ...
                  data-sanity={detailDataAttribute('ctaButtonText')}
                >
        ...
        {page && <RelatedTreatmentsSection cards={page.cards} currentSlug={detail.slug} />}
      </main>
      <Footer />
    </div>
  );

...
export default function ProcessSection() {
  ...
  const handleNext = () => setActiveStep((prev) => Math.min(processSteps.length - 1, prev + 1));
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn direction="up" delay={0}>
          <div className="text-center mb-14">
            <h2 className="text-4xl font-serif font-bold text-[#cd9651] mb-3">初診流程</h2>
            <p className="text-gray-500 text-base">五個步驟，開啟您的健康守護之旅</p>
          </div>
        </FadeIn>
          ...
          <div className="bg-[#f9f7f4] rounded-2xl overflow-hidden shadow-md flex flex-col lg:flex-row min-h-[320px]">
            ...
            <div className="lg:w-1/2 w-full flex flex-col justify-between p-8 lg:p-10">
              ...
              <div className="flex items-center gap-4 mt-8">
                ...
                <span className="text-sm text-gray-400">{activeStep + 1} / {processSteps.length}</span>
              </div>
            </div>
          </div>
        </FadeIn>

    ...
    <section className="relative min-h-screen w-full overflow-hidden bg-[#f8f6f1]">
      ...
      <div className="relative z-10 min-h-screen flex flex-col justify-center px-8 sm:px-12 lg:px-20 xl:px-28">
        <div className="max-w-xl">
          {/* 主標題 */}
          <h1
            className={`mb-8 ${base} duration-700 ${mounted ? visible : hidden}`}
      ...
      {/* Scroll 提示 */}
      <div
        className={`absolute bottom-12 left-1/2 -translate-x-1/2 z-10 ${base} duration-700 ${mounted ? 'opacity-100' : 'opacity-0'}`}
